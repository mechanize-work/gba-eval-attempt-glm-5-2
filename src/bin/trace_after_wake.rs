    ...
    for i in 0..300000u64 {
        ...
        if v15e0 != last_15e0 {
            ...
            for j in 0..500u32 {
                ...
                if pc == 0x0800070C || pc == 0x08000714 || pc == 0x08000716 || pc == 0x08000726 || 
                   (instr_is_swi(emu, pc) && j > 0) {
...
fn instr_is_swi(emu: &gba_emu::emulator::Emulator, pc: u32) -> bool {
    if emu.cpu.is_thumb() {
